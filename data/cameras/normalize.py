...
def normalize_cameras(original_cameras_filename,output_cameras_filename,num_of_cameras=-1):
...
if __name__ == "__main__":
    split = 'test'
    input_cameras_file = "/mnt/data/cxy_colmap/volsdf/data/cameras/cameras_{}.npz".format(split)
    output_cameras_file = "/mnt/data/cxy_colmap/volsdf/data/cameras/cameras_normalized_{}.npz".format(split)
    normalize_cameras(input_cameras_file, output_cameras_file)
